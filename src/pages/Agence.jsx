  ...
  return (
    <div>
      <div className='section1'>
        <div ref={imageDivRef} className='w-[15vw] h-[20vw] rounded-4xl overflow-hidden absolute top-40 left-[30vw] '>
          <img className='h-full object-cover w-full ' src="https://images.unsplash.com/photo-1520697830682-bbb6e85e2b0b?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
